...
namespace Unity.XR.PXR
{
    ...
    public struct PxrLayerParam
    {
        ...
        public UInt64[] leftExternalImages;
        public UInt64[] rightExternalImages;
    };
    ...
    {
        private const string PXR_SDK_Version = "2.0.1.14";
        ...
        public static class Render
        {
            ...
            public static int UPxr_CreateLayer(IntPtr layerParam)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
